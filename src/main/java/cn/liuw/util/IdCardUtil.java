...
/**
 * Created by liuw on 2017/2/21.
 */
public class IdCardUtil {

    private static final int CONST_ID_PROVINCE_LENGTH = 2;
    ...
    private static final Map<String, String> MAP_PROVINCE;
    ...
    static {
        ...
        MAP_PROVINCE = Collections.unmodifiableMap(map);
    }
    ...
    public static String getProvince(String cardNo) {
        ...
        // check身份证号
        if(cardNo == null || cardNo.length() < CONST_ID_PROVINCE_LENGTH) {
            return province;
        }

        province = MAP_PROVINCE.get(cardNo.substring(0, 2));

        return province != null ? province : "";
    }

    public static Map<String,String> getProvinceList() {
        Map<String,String>  enrolleeTotalBeanList = MAP_PROVINCE;

        return enrolleeTotalBeanList;
    }
    ...
    private static boolean validateIdCard15(String idCard) {
        ...
        if (isNum(idCard)) {
            ...
            if (MAP_PROVINCE.get(proCode) == null) {
                return false;
            }
